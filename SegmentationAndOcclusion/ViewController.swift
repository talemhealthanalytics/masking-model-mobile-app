...
//  Adaped by Rohit Singh for THA on Tue Oct 26, 2021
//

// Imports ------------------------------------------------
import UIKit
import Vision           // Vision is used for detection, classification and segmentation
import ARKit
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    // --------------------------------------------------------------------------------
    // Function Name: segmentationRequest
    //
    // Function inputs:
    // Function outputs:
    //
    ...
    // --------------------------------------------------------------------------------
    // Function Name: objectDetectionRequest
    //
    // Function inputs:
    // Function outputs:
    //
    ...
    func renderer(_ renderer: SCNSceneRenderer, willRenderScene scene: SCNScene, atTime time: TimeInterval) {
        ...
        // Take into account the different aspect ratios
        ...
        let imageRequestHandler = VNImageRequestHandler(cvPixelBuffer: capturedImage,
                                                        ...
                                                        options: [:])
        do {
            // Perform the requests to detect and segment the cars
